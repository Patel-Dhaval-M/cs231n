...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params["W2"] = np.random.normal(0, weight_scale, [num_filters * np.int(H/2) * np.int(W/2), hidden_dim])
    ...
    def loss(self, X, y=None):
        ...
        # variable.                                                                #
        ############################################################################
        conv_layer, conv_layer_cache = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        hidden_layer, hidden_layer_cache = affine_relu_forward(conv_layer, W2, b2)
        ...
        dx2, dw2, db2 = affine_relu_backward(dx3, hidden_layer_cache)
        grads["W2"], grads["b2"] = dw2 + self.reg * W2, db2

        dx1, dw1, db1 = conv_relu_pool_backward(dx2, conv_layer_cache)
